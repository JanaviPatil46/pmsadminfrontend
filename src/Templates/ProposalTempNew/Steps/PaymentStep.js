        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="rounded-xl border border-slate-200 bg-slate-50/50 p-6 space-y-4">
            ...
            <div className="space-y-1.5" onBlur={() => handleBlur('method')}>
              ...
              <select value={formData.payments.method || ''} onChange={(e) => handleFieldChange('method', e.target.value)} className={`flex h-10 w-full rounded-lg border bg-white px-3 py-2 text-sm shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 ${stepErrors.method ? 'border-red-400' : 'border-slate-200'}`}>
                <option value="">Select Payment Method</option>
