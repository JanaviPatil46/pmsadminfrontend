...
const PaymentStep = ({ 
  ...
  return (
    <div className="space-y-6">
      <h2 className="text-2xl font-semibold text-blue-600">Payment Information</h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 space-y-6">
          <div className="rounded-xl border border-slate-200 bg-slate-50/50 p-6 space-y-4">
            <h3 className="text-base font-semibold text-blue-600">Payment Details</h3>
            ...
            <div className="space-y-1.5" onBlur={() => handleBlur('method')}>
              ...
              <select value={formData.payments.method || ''} onChange={(e) => handleFieldChange('method', e.target.value)} className={`flex h-10 w-full rounded-lg border bg-white px-3 py-2 text-sm shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 ${stepErrors.method ? 'border-red-400' : 'border-slate-200'}`}>
                <option value="">Select Payment Method</option>
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input type="number" value={formData.payments.amount || 0} readOnly onBlur={() => handleBlur('amount')} className={`flex h-10 w-full rounded-lg border bg-slate-100 pl-7 pr-3 py-2 text-sm shadow-sm focus:outline-none ${stepErrors.amount ? 'border-red-400' : 'border-slate-200'}`} />
              </div>
            ...
            {formData.payments.method && (
              <div className="rounded-lg border border-slate-200 bg-white p-4 mt-3 space-y-2">
                <p className="text-sm font-semibold text-blue-600">{formData.payments.method} Instructions</p>
          ...
          <div className="rounded-xl border border-slate-200 p-6 space-y-3">
            <h3 className="text-base font-semibold text-blue-600">Payment Summary</h3>
            ...
            <div className="flex justify-between"><span className="text-sm font-bold text-slate-800">Client Will Pay:</span><span className="text-sm font-bold text-blue-600">${parseFloat(formData.payments.amount || 0).toFixed(2)}</span></div>
          </div>
        </div>
