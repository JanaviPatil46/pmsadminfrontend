            ...
            <FormSection title="Email & Reminders">
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <Switch checked={emailToClient} onCheckedChange={(checked) => setEmailToClient(checked)} />
                </div>
                {emailToClient && (
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch checked={payUsingCredits} onCheckedChange={(checked) => setPayUsingCredits(checked)} />
                </div>

                <div className="flex items-center justify-between">
                  <Label className="text-sm">Send reminders to clients</Label>
                  <Switch checked={invoiceReminders} onCheckedChange={(checked) => setInvoiceReminders(checked)} />
                </div>
                {invoiceReminders && (
