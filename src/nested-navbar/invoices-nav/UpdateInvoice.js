          ...
          <Grid container rowSpacing={1} columnSpacing={{ xs: 1, sm: 2, md: 3 }}>
            <Grid xs={6}>
              <Box>
                ...
                <TextField fullWidth disabled value={invoicenumber} onChange={(e) => setinvoicenumber(e.target.value)} placeholder="Invoice Number" size="small" sx={{ mt: 1 }} />
              </Box>
            </Grid>
            <Grid xs={6}>
              <Box>
