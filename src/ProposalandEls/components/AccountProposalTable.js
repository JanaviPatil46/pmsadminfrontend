   ...
   useEffect(() => {
     const fetchData = async () => {
       try {
         ...
         const response = await fetch(`https://www.snptaxes.com/account/proposals/${data}`, requestOptions);
           ...
           <TableBody>
             {proposals.map((proposal) => (
               ...
               >
                 ...
                 <TableCell onClick={() => handleProposalNameClick(proposal)} style={{ cursor: "pointer" }}>
