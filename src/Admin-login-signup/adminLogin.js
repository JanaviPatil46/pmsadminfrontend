            ...
            <Box textAlign="center" mb={5}>
              ...
              <Box mt={3} mb={5} px={6}>
                ...
                {/* <Typography variant="body1" fontSize="20px">
                  Our tax consultancy services offer expert guidance on
                  navigating complex tax landscapes. From personalized tax
                  planning to compliance assistance, we ensure your financial
                  strategies align with current regulations. Trust us to
                  maximize your deductions, minimize liabilities, and provide
                  clarity in the ever-evolving tax environment. Your financial
  ...
  TAILWIND TEST
        ...
        <Grid item xs={16} sm={8}>
          <RightItem className="right-container">
            <Box
              className="login-right col-6"
              sx={{ textAlign: "left", padding: "10px", mt: 2 }}
            >
              ...
              <Box>
                ...
                <Box mt={2}>
                  ...
                  <FormControl sx={{ mt: 2, width: "100%" }} variant="outlined">
                    <Typography htmlFor="outlined-adornment-password" mb={2}>
                      Password
                    </Typography>
                    <OutlinedInput
                  ...
                  >
                    <Link
                      component={NavLink}
                      to="/forgotpass"
                      sx={{ color: "cornflowerblue", textDecoration: "none" }}
                    >
                      Forgot Password?
                    </Link>
                  </Box>
